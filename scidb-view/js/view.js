	...
	function initSliders() {
		...
		$('#slider-top-vertical-0').slider({
			...
			change: function(event,ui){ 
				...
				var vieweridchanged=$('#slice-top-input-0').parent().parent().find(".viewer").attr("id");
		...
		$('#slider-top-vertical-1').slider({
			...
			change : function( event, ui ) {
				...
				var vieweridchanged=$('#slice-top-input-1').parent().parent().find(".viewer").attr("id");
		...
		$('#slider-top-vertical-2').slider({
			...
			change: function( event, ui ) {
				...
				var vieweridchanged=$('#slice-top-input-2').parent().parent().find(".viewer").attr("id");
