$(function() {
	...
	function initSliders(viewerid){
		...
		$("#"+viewerid).find(".view.side").prepend('<input type="text" value="'+Math.floor((width-1)/2)+'" id="slice-side-input-'+viewernumber+'" class="slice-text side" style="line-height:'+width+'px"/><div id="slider-side-vertical-'+viewernumber+'" class="slider side" style="float:left;height: '+(depth)+'px;"></div>');
		$("#"+viewerid).find(".view.front").prepend('<input type="text" value="'+Math.floor((height-1)/2)+'" id="slice-front-input-'+viewernumber+'" class="slice-text front" style="line-height:'+width+'px"/><div id="slider-front-vertical-'+viewernumber+'" class="slider front" style="float:left;height: '+(depth)+'px;"></div>');
		//});
